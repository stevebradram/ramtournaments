...
import theRamOdds from '../components/Helper/theRamOdds.json'
var oddArr5={
    "-10000":"1.01",
    "-9999":"1.01",
    "-9998":"1.01",
   ...
   /* if(f1Name!==item2.awayTeam&&f2Name!==item2.homeTeam){
    ...
    theFightsJson[index]['timeInMillis']=matchMillis
       ...
       if(f1Name===item2.homeTeam||f2Name===item2.awayTeam){
            ...
            /*if(item2.homeTeamPoints>-10000){}
            if(item2.awayTeamPoints>-10000){}
            if(item2.homeTeamPoints>12620){}
            if(item2.awayTeamPoints>12620){}
            if(item2.homeTeamPoints<100&&item2.homeTeamPoints<-100){}
           ...
           // console.log('item2.awayTeamPoints',aTPoints,aTPointsNum)
            ...
            if(f1Name===item2.awayTeam||f2Name===item2.homeTeam){
                ...
                if(subDifference>item2.timeInMillis){
                    ...
                    theFightsJson[index]['p2Points']=hTPointsNum
     ...
     sortOddsJson=async(theOddsJson)=>{
        ...
        var oddsCount=0
       await theOddsJson.map((item1,index)=>{
            oddsCount++
            var i=0,newOddsJson=[]
