...
// Perform delete action
  ...
  checkUpcomingPastGames = async (userId) => {
    ...
    await homeRef2.once('value', hs2 => { var hv2 = hs2.val(); if (hv2 && hv2.id) { this.pinnedHomeIdVal = hv2.id } })
    //return
