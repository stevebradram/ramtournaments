                ...
                {this.state.areMessagesAvailable?<>{this.state.theChats.map((item,index)=>{
                 ...
                 <div className={styles.headerDiv}>
                    <HiArrowNarrowLeft  className={styles.backIc} onClick={()=>this.closeMessenger()}/>
                        ...
                        {this.state.profilePhoto!=='N/A'?<Image className={styles.theUserImg} src={theImg}  alt={'RAM User'} height={40} width={40} objectFit='fit'/>:
                                              <p className={styles.acroP}>{this.state.acronym}</p>}
                        </div>
                        <div>
                            <p className={styles.userNameP}>{'Kim John'}</p>
                            <p className={styles.lastSeenP}>Last Seen {'2 Hrs ago'} </p>
