...
class UFCEvent extends Component {
  ...
  render() {
    ...
    var theTitle = this.state.theEventTitle
    ...
    return (
      <div className={style.container}>
        ...
        {this.state.sportType === 'NCAAF' || this.state.sportType === 'NCAAB' || this.state.sportType === 'NFL' || this.state.sportType === 'NFLRegular' ? <p className={style.eveP} style={{ marginTop: 10, marginBottom: -30 }}>Event: <span>{theTitle}</span></p> : null}
